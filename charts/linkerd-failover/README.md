...
| nodeSelector | object | `{}` | nodeSelector sections. For information on node selector sections, please refer  [ K8s documentation](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#nodeselector) for more details. |
